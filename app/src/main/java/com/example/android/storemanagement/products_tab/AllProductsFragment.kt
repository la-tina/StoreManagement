...
class AllProductsFragment : ProductsTabFragment() {
    ...
    override fun setupViewModel() {
        viewModel = ViewModelProviders.of(this).get(AllProductsViewModel(requireActivity().application)::class.java)
    }
    ...
    override fun setupRecyclerView() {
        products_recycler_view?.let { recyclerView ->
            ...
            val productsAdapter = ProductsAdapter(requireContext(), ::deleteProduct, ::openEditProductTab)
